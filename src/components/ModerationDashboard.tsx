...
export default function ModerationDashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const warningsIssued = actionsData?.filter(a => a.action === 'warn').length || 0;
      const postsRemoved = actionsData?.filter(a => a.action === 'delete').length || 0;
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-1">
                              <h3 className="font-medium">{getActionTitle(action.action)}</h3>
