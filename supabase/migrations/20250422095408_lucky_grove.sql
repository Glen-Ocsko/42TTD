...
-- Policies for moderation_actions - check if they exist first
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'moderation_actions' 
    AND policyname = 'Moderators can create moderation actions'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'moderation_actions' 
    AND policyname = 'Moderators can view all moderation actions'
  ) THEN
...
-- Policies for user_suspensions - check if they exist first
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_suspensions' 
    AND policyname = 'Moderators can create user suspensions'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_suspensions' 
    AND policyname = 'Moderators can update user suspensions'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_suspensions' 
    AND policyname = 'Moderators can view all user suspensions'
  ) THEN
...
-- Policies for moderation_messages - check if they exist first
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'moderation_messages' 
    AND policyname = 'Moderators can create messages'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'moderation_messages' 
    AND policyname = 'Moderators can view all messages'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'moderation_messages' 
    AND policyname = 'Users can view messages sent to them'
  ) THEN
...
-- Policies for post_reports - check if they exist first
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'post_reports' 
    AND policyname = 'Moderators can view all reports'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'post_reports' 
    AND policyname = 'Moderators can update reports'
  ) THEN
